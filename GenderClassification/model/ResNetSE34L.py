...
class ResNetSE(nn.Module):
    def __init__(self, nOut, block=SEBasicBlock,layers=[3,4,6,3], num_filters=[16,32,64,128], encoder_type='SAP', n_mels=40, log_input=True):
        ...
        self.torchfb        = torchaudio.transforms.MelSpectrogram(sample_rate=8000, n_fft=256, win_length=200, hop_length=80, window_fn=torch.hamming_window, n_mels=n_mels)
