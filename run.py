...
if __name__ == "__main__" : 
    ...
    parser.add_argument('--dir_in',"-i",type=str,required=False,default="cuda:0")
    parser.add_argument('--dir_out',"-o",type=str,required=False,default="cuda:0")
    ...
    list_target = glob.glob(os.path.join(dir_in,"*.wav"))
